    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          ...
          <a id="getPDF" class="btn btn-sm btn-neutral text-primary"">PDF</a>
              ...
              <?php if (!empty($data)) : ?>
                ...
                foreach ($data as $value) : ?>
                  <tr>
                    ...
                    <td class="text-right" id="ignorePDF2">
                      <div class="dropdown" id="ignorePDF2">
                        <a class="btn btn-sm btn-icon-only text-light" href="#" role="button" id="ignorePDF" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <i class="fas fa-ellipsis-v"></i>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow" id="ignorePDF2">
                          <a id="ignorePDF" class="dropdown-item" href="<?php echo base_url() . "producto/" . $value->id; ?>">Editar</a>
                          <a id="ignorePDF" class="dropdown-item" href="<?php echo base_url() . "producto/delete/" . $value->id; ?>">Elimnar</a>
                        </div>
                      </div>
                    </td>
                  </tr>
